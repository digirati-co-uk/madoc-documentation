...
From the [IIIF Specification](https://iiif.io/api/presentation/3.0/#53-canvas):
...
<style>{`.atlas { --atlas-background: #EEE; margin: 20px 0; }`}</style>
<style>{`.dark .atlas { --atlas-background: #000; margin: 20px 0; }`}</style>



From the [IIIF Specification](https://iiif.io/api/presentation/3.0/#52-manifest):
...
From the [IIIF Specification](https://iiif.io/api/presentation/3.0/#51-collection):
