...
Under [project settings](../contribution-options#modelPageOptions) there is an option to allow users to make their own notes that only they can see while they are working through a manifest.
